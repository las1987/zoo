...
class IndexAdmin extends Simpla
{
	...
	private $modules_permissions = array(
		...
		'OrdersAdmin'         => 'orders',
		'OrderAdmin'          => 'orders',
		'OrdersNurseryAdmin'  => 'orders_nursery',
		...
		'ImportAdmin'         => 'import',
        'ReloadAdmin'         => 'prices_update',
        'Reload2Admin'         => 'prices_update',
		'ExportAdmin'         => 'export',
		'BackupAdmin'         => 'backup',
		'StatsAdmin'          => 'stats',
		'ThemeAdmin'          => 'design',
        ...
        'DestinationsAdmin'   => 'delivery',
        'DestinationAdmin'    => 'delivery',
        ...
        'ReviewAdmin'         => 'reviews',
        'DiscussionsAdmin'    => 'discussions',
        'DiscussionAdmin'     => 'discussions',
        'PromosAdmin'         => 'promos',
        'PromoAdmin'          => 'promos',
        'BestBuysAdmin'        => 'promos',
        'NewsAdmin'           => 'news',
        'NewsItemAdmin'       => 'news',
        'ArticlesAdmin'       => 'articles',
        'ArticleAdmin'        => 'articles',
        'AdvertsAdmin'        => 'adverts',
        'AdvertAdmin'         => 'adverts',
        'ForumAdmin'          => 'forum',
        'CallOrdersAdmin'     => 'call-orders',
        'SubscriptionsAdmin'  => 'subscriptions',
        'BDUserAdmin'		  => 'users',
        'DPD_class'           => 'orders',
		'ParserViewAdmin'     => 'parser',
		'ProductStatisticsAdmin'     => 'parser',
		'EventsAdmin'		=> 'events',
		'TownsAdmin'		=> 'settings',
		'AttentionAdmin'	=> 'attention',
		'DictionariesAdmin'	=> 'dictionaries',
		'CardsOfTheFriendsAdmin' => 'cardsofthefriends',
		'PrettyUrlListAdmin' => 'pretty_url',
	...
	function fetch()
	{
        ...
        if(isset($this->modules_permissions[$moduleClass])
		&& $this->managers->access($this->modules_permissions[$moduleClass]))
		{
        ...
        $new_reviews_counter = $this->reviews->count_reviews(array('approved'=>0));
        $this->design->assign("new_reviews_counter", $new_reviews_counter);

        $new_discussions_counter = $this->discussions->count_discussions(array('approved'=>0));
        $this->design->assign("new_discussions_counter", $new_discussions_counter);

        $new_call_orders_counter = $this->call_orders->count_call_orders(array('status'=>0));
        $this->design->assign("new_call_orders_counter", $new_call_orders_counter);
